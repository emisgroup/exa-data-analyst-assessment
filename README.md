...
## The Solution
You can use any data storage engine you feel fits however solutions should be saved as .SQL files
Your solution should be accompanied by a breakdown of you findings around data availability, quality and any data issues you have identified
